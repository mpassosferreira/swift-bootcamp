...
<p align="center">
  <p align="center">
This is a simples example of inheritance concept.
    <br />
    <br />
    ...
    <br />
    <br />
    <img src="poo-inheritance.png" alt="POO - Inheritance" width="800" height="600">
  </p>
 </p>
  
### About

Inheritance is one of the main concepts of object-oriented programming (OOP) languages. You will use that when you want to derive a class from another class. 
...
```
2. Open folder \poo-inheritance and double-click the file inheritance.playground.

3. Run all the code, you should get "Would you consider to give some tips to Marcio?"
